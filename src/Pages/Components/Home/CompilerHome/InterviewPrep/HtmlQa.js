...
const HtmlQa = () => {
    return (
        <div className='m-5 p-8 text-white'>
            ...
            <div className='hover:shadow-lg hover:shadow-white px-5 pb-4'> <h1 className='text-yellow-500 font-semibold mt-5'>Question-05: What is the difference between inline, inline-block, and block? </h1>
