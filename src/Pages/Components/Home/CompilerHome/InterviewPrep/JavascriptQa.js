    ...
    return (
        <div className='m-5 p-8 text-white'>
            ...
            <div className='hover:shadow-lg hover:shadow-white px-5 pb-4'>
                ...
                <p><span className='text-black font-semibold'>Answer:</span><br /> “==” is a type converting operator. It is used for comprising two string objects rather than value. It is used for checking data types values like int, and float. It is used to compare the value of primitive variables and the memory location of objects.
            ...
            <div className='hover:shadow-lg hover:shadow-white px-5 pb-4'> <h1 className='text-yellow-500 font-semibold mt-5'>Question-05: When will you return something from a function? </h1>
            ...
            <div className='hover:shadow-lg hover:shadow-white px-5 pb-4'> <h1 className='text-yellow-500 font-semibold mt-5'>Question-06:  Tell me about bind, call and apply.
            </h1>
